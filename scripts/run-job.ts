import { runFinalizeReviewRoundsJob, runPurgeRejectedJob, runRevalidateSkillsJob } from "../src/lib/jobs";
...
async function main() {
  ...
  switch (job) {
    ...
    case "revalidate-skills":
      ...
      break;
    default:
      console.error("Usage: npm run job -- <finalize-review-rounds|purge-rejected|revalidate-skills>");
      process.exit(1);
  }
}
